...
public class Users extends TableImpl<UsersRecord> {
   ...
   */
  public final TableField<UsersRecord, String> ID = createField(DSL.name("ID"),
      SQLDataType.VARCHAR(36).nullable(false), this, "");
  /**
   * The column <code>USERS.FIRST_NAME</code>.
   */
  public final TableField<UsersRecord, String> FIRST_NAME = createField(DSL.name("FIRST_NAME"),
      SQLDataType.VARCHAR(255).nullable(false), this, "");
  /**
   * The column <code>USERS.LAST_NAME</code>.
   */
  public final TableField<UsersRecord, String> LAST_NAME = createField(DSL.name("LAST_NAME"),
      SQLDataType.VARCHAR(255).nullable(false), this, "");
  /**
   * The column <code>USERS.BIRTH_DATE</code>.
   */
  public final TableField<UsersRecord, LocalDate> BIRTH_DATE = createField(DSL.name("BIRTH_DATE"),
      SQLDataType.LOCALDATE.nullable(false), this, "");
  /**
   * The column <code>USERS.BIOGRAPHY</code>.
   */
  public final TableField<UsersRecord, String> BIOGRAPHY = createField(DSL.name("BIOGRAPHY"),
      SQLDataType.CLOB, this, "");
  /**
   * The column <code>USERS.CITY</code>.
   */
  public final TableField<UsersRecord, String> CITY = createField(DSL.name("CITY"),
      SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>USERS.ENCODED_PASSWORD</code>.
   */
  public final TableField<UsersRecord, String> ENCODED_PASSWORD = createField(
      DSL.name("ENCODED_PASSWORD"), SQLDataType.VARCHAR(255).nullable(false), this, "");
