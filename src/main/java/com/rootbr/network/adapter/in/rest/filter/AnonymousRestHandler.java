...
public class AnonymousRestHandler implements RestHandler {
  private final TokenService tokenService;
  private final SocialNetworkApplication application;
  private final RestHandler delegate;

  public AnonymousRestHandler(final TokenService tokenService,
  ...
  public void handle(final HttpExchange exchange, final JsonFactory factory,
    ...
    if (authHeader == null) {
      delegate.handle(exchange, factory, this.application.anonymous(), this.application, pathVariables, queryParameters);
      return;
    }
